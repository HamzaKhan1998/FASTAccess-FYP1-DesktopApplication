...
/*
        ...
        private void button_WOC1_Click_1(object sender, EventArgs e)
        {
            ...
            searchPaths.Add(@"C:\\Users\\ubaid\\Desktop\\Uni\\FYP 2\\New folder\\FAST Access\\FAST Access\\FAST Access\\Lib");
            py.SetSearchPaths(searchPaths);
            py.ExecuteFile(@"C:\\Users\\ubaid\\AppData\\Local\\Programs\\Python\\Python39\\Lib\\MainAlgorithm.py");
            MessageBox.Show("Please wait while the time-table is being generated");
...
//            string fname = "Desktop/TimeTable.xlsx";
            ...
            saveFileDialog1.Title = "Save TimeTable";
                    ...
                    using (SQLiteDataAdapter sqlda = new SQLiteDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            using (XLWorkbook wb = new XLWorkbook())
                            {
                                ...
                                wb.SaveAs(fullpath);
                                MessageBox.Show("Time Table Exported Successfuly to "+fullpath);
                            }
                        }
                    }
                }
